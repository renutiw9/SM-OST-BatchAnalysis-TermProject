	...
	public class TestNetwork {
	    ...
	    public TestBank(SQLContext ss, ArrayList<String> test_names, String datasetPath) {
	        ...
	        List<StructField> fields = Arrays.asList(
	                ...
	                DataTypes.createStructField("Lenght", DataTypes.IntType, true),
	        ...
	        // PREPROCESSING
	        //DurationTransformer myTransformer = new DurationTransformer("time");
	
	        String[] inputCols = {"source", "destination", "protocol", "info"};
